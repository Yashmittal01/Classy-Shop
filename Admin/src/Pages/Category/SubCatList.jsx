...
import product1 from "../../assets/cat4.png";
        ...
        <div className="flex items-center justify-between px-1 py-0">
          ...
          <div className="col w-[35%] ml-auto flex items-center justify-end gap-3">
            ...
            <Button className="btn-sm !text-white !bg-[#ff5252] whitespace-nowrap gap-1" onClick={()=>context.setIsOpenFullScreenPanel({
              ...
              <IoMdAdd className="!text-[20px]"/>Add New Sub Category
            </Button>
          </div>
        </div>
            ...
            <Table stickyHeader aria-label="sticky table">
              ...
              <TableBody>
                <TableRow>
                  ...
                  <Chip label="Men" sx={{backgroundColor: "#ff5252", color: "#fff"}}/>
                  <Chip label="Women" sx={{backgroundColor: "#ff5252", color: "#fff"}}/>
                  <Chip label="Kids" sx={{backgroundColor: "#ff5252", color: "#fff"}}/>
                  </div>
                  </TableCell>
