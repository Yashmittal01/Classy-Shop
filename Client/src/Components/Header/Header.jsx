  ...
  return (
    <>
      <header className="bg-white">
        <div className="top_strip py-2 border-t-[1px] border-b-[1px] border-gray-200">
            ...
            <div className="col3 w-[35%] flex items-center pl-7">
              <ul className="flex items-center gap-3 w-full justify-end">
                {context.Islogin == false ? (
                  ...
                  <>
                    <Button
                      className="myaccount !text-black flex items-center gap-3"
                      onClick={handleClick}
                    >
                      ...
                      <div className="info flex flex-col leading-4.5">
                        <h3 className="text-[14px]  capitalize text-left justify-start text-[rgba(0,0,0,0.6)] font-[500]">
                          {context?.userData?.name}
                        </h3>
                        <span className="text-[13px] font-[400] capitalize text-left justify-start text-[rgba(0,0,0,0.6)]">
                ...
                <li>
                  <Tooltip title="Cart">
                    <IconButton
                      aria-label="cart"
                      onClick={() => context.setOpenCartPannel(true)}
                    >
                      <StyledBadge badgeContent={4} color="secondary">
                        <MdShoppingCart />
                      </StyledBadge>
