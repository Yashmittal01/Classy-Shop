...
function ProductItemListView() {
  ...
  return (
    <div className="productitem border-1 overflow-hidden shadow-md rounded-md border-[rgba(0,0,0,0.1)] flex items-center">
      ...
      <div className="info p-3 py-5 w-[75%] px-8">
        ...
        <h3 className="text-[18px] title mt-3 mb-3 font-[500] text-black">
...
<div className="mt-3">
        <Button className="!bg-[#ff5252] !text-white !font-[500] !text-[13px] px-4 py-2 hover:!bg-black flex gap-2"><MdOutlineShoppingCart className="text-[20px]"/>Add To Cart</Button>
        </div>
      </div>
    </div>
  );
